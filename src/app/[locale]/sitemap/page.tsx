...
import { Heading1, Link, Status } from "../../../components";
...
export default async function HuwelijksplannerStep0() {
  return (
    <>
        ...
        steps={[
          {
            ...
            marker: " ",
            status: "checked",
            title: (<Link href="/">Digitaal loket: Regel je huwelijk of geregistreerd partnerschap</Link>) as any,
            meta: (
              <Link href="https://frameless.github.io/utrecht-huwelijksplanner-eend/" target="huwelijksplanner-design">
                design
              </Link>
            ),
          },
          ...
          },
          {
            ...
            steps: [
              ...
              },
              {
                ...
                title: (
                  <Link href="/login" aria-label="Stap 4: Inloggen en gegevens controleren — Inloggen met DigiD">
                    Inloggen met DigiD
                  </Link>
                ) as any,
                meta: (
              ...
              },
              {
                ...
                title: (
                  <Link href="/persoonsgegevens/EC4D6AEF-0E23-4686-8778-71D2C02D7A38">Aanvullen persoonsgegevens</Link>
                ) as any,
                meta: (
                  <Link
          ...
          },
          {
            ...
            marker: "6",
            title: (<Link href="/voorgenomen-huwelijk/checken">Stap 6: Gemeente Utrecht controleert</Link>) as any,
            meta: (
              <Link
