...
export default function MultistepForm1() {
  ...
  useEffect(() => {
    ...
    if (!marriageOptions.id && reservation && !loading) {
      initializeMarriage();
      pageInitialized.current = true;
    }
  }, [huwelijkId, initializeMarriage, loading, marriageOptions, reservation, setMarriageOptions]);
